> **Status:** current (supporting reference — ui-system — animation reference). Predates the 2026-07-02 spec rewrite; where this conflicts with code or the owning spec's requirements/design, those win.
...
0ms (0%):
â”œâ”€ Project Card: scale(1.0), z-index(auto)
â”œâ”€ Background: blur(0px), opacity(1.0)
â””â”€ Modal: opacity(0), scale(0.8), y(20px)

100ms (14%):
â”œâ”€ Project Card: scale(1.05), z-index(100)
â”œâ”€ Background: blur(2px), opacity(0.95)
â””â”€ Modal: opacity(0.1), scale(0.85), y(15px)

200ms (29%):
â”œâ”€ Project Card: scale(1.10), z-index(100)
â”œâ”€ Background: blur(4px), opacity(0.8)
â””â”€ Modal: opacity(0.3), scale(0.9), y(10px)

350ms (50%):
â”œâ”€ Project Card: scale(1.15), z-index(100)
â”œâ”€ Background: blur(6px), opacity(0.65)
â””â”€ Modal: opacity(0.6), scale(0.95), y(5px)

500ms (71%):
â”œâ”€ Project Card: scale(1.18), z-index(100)
â”œâ”€ Background: blur(7px), opacity(0.55)
â””â”€ Modal: opacity(0.8), scale(0.98), y(2px)

700ms (100%):
â”œâ”€ Project Card: scale(1.2), z-index(100)
â”œâ”€ Background: blur(8px), opacity(0.5)
â””â”€ Modal: opacity(1.0), scale(1.0), y(0px)
```
...
0ms (0%):
â”œâ”€ Position: bottom(30vh)
â”œâ”€ Scale: 1.0
â””â”€ Glow: opacity(0)

150ms (21%):
â”œâ”€ Position: bottom(25vh)
â”œâ”€ Scale: 1.02
â””â”€ Glow: opacity(0.1)

350ms (50%):
â”œâ”€ Position: bottom(15vh)
â”œâ”€ Scale: 1.0
â””â”€ Glow: opacity(0.2)

550ms (79%):
â”œâ”€ Position: bottom(5vh)
â”œâ”€ Scale: 1.0
â””â”€ Glow: opacity(0.25)

700ms (100%):
â”œâ”€ Position: bottom(24px)
â”œâ”€ Scale: 1.0
â””â”€ Glow: opacity(0.3)
```
...
0ms (0%):
â”œâ”€ Box Shadow: none
â”œâ”€ Background: transparent
â””â”€ Transform: scale(1.0)

100ms (33%):
â”œâ”€ Box Shadow: 0 0 0 2px rgba(primary, 0.2)
â”œâ”€ Background: rgba(primary, 0.05)
â””â”€ Transform: scale(1.01)

200ms (67%):
â”œâ”€ Box Shadow: 0 0 0 3px rgba(primary, 0.25)
â”œâ”€ Background: rgba(primary, 0.08)
â””â”€ Transform: scale(1.02)

300ms (100%):
â”œâ”€ Box Shadow: 0 0 0 4px rgba(primary, 0.3)
â”œâ”€ Background: rgba(primary, 0.1)
â””â”€ Transform: scale(1.02)
```
...
0ms (0%):
â”œâ”€ Outline: 2px solid transparent
â””â”€ Outline Offset: 2px

150ms (50%):
â”œâ”€ Outline: 2px solid rgba(primary, 0.5)
â””â”€ Outline Offset: 3px

300ms (100%):
â”œâ”€ Outline: 2px solid var(--primary)
â””â”€ Outline Offset: 4px
```
...
150ms (21%):
â”œâ”€ X: Â±50px (direction based on position)
â”œâ”€ Opacity: 0.8
â””â”€ Scale: 0.95
...
0ms (0%):
â”œâ”€ All Colors: current theme values
â””â”€ Transition: none

50ms (17%):
â”œâ”€ All Colors: interpolated values (17%)
â””â”€ Transition: active

150ms (50%):
â”œâ”€ All Colors: interpolated values (50%)
â””â”€ Transition: active

300ms (100%):
â”œâ”€ All Colors: new theme values
â””â”€ Transition: active
```
