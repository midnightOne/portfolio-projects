...
**Status:** current — **Block A complete (2026-07-09); B–L open**
**Owner domain:** node-graph conversation engine (see requirements.md)
**Last verified against code:** 2026-07-09 (Block A landed + drilled in-session; seam audit in design §5 now stale for updateSession/D55 buffer/log envelope — all three exist)
