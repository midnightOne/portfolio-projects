...
[Chunk 1: lines 1-150]      ← Spans H1 and H2
[Chunk 2: lines 100-250]    ← Overlap, crosses H2 boundary
[Chunk 3: lines 200-350]    ← Spans H2 and H3
[Chunk 4: lines 300-450]    ← Crosses H3 boundary
```

**Problems**:
1. Edit H2 → Invalidates chunks 1, 2, 3 (even though H1 and H3 unchanged)
...
```
H1: Introduction                    ← Section A
Line 0: # Introduction              ← Heading (always line 0)
Line 1: This project demonstrates   ← Content starts
Line 2: advanced AI techniques
...
Line 14: leading to great results   ← Section A ends (15 lines total)

H1: Implementation                  ← Section B  
Line 0: # Implementation            ← Heading (new section = new line 0)
Line 1: The technical approach      ← Content starts
...
Line 9: resulting in success        ← Section B ends (10 lines total)

H1: Advanced Features               ← Section C
Line 0: # Advanced Features         ← Heading (new section = new line 0)
Line 1: The system includes
...
Line 89: comprehensive analytics    ← Section C ends (90 lines total)
```
...
H1: Implementation (lines 181-500, 800 tokens)
  [T3-4: lines 181-350]     ← Split within section
  [T3-5: lines 325-500]     ← 25 token overlap, still within section
```

**Benefits of Section-Relative Line Numbering**:
1. **Section Isolation**: Edit Section A → Only Section A chunks need updating
...
→ [T3 chunk 1: paragraphs 1-3, ~400 tokens]
→ [T3 chunk 2: paragraphs 3-6, ~425 tokens]  // 25 token overlap
→ [T3 chunk 3: paragraphs 6-9, ~400 tokens]  // 25 token overlap
```
