...
The platform has processed over $2M in transactions in its first year, with 99.9% uptime and consistently positive user feedback regarding performance and ease of use.`;
  ...
  const modelPricing: Array<{ modelId: string; provider: string; inputPerMTokUsd: number; outputPerMTokUsd: number; notes?: string }> = [
    ...
    { modelId: 'claude-sonnet-4-20250514', provider: 'anthropic', inputPerMTokUsd: 3, outputPerMTokUsd: 15 },
    { modelId: 'claude-3-5-haiku-20241022', provider: 'anthropic', inputPerMTokUsd: 0.8, outputPerMTokUsd: 4 },
