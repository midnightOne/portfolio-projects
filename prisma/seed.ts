...
async function main() {
  ...
  const modelPricing: Array<{ modelId: string; provider: string; inputPerMTokUsd: number; outputPerMTokUsd: number; notes?: string }> = [
    ...
    { modelId: 'gpt-realtime', provider: 'openai', inputPerMTokUsd: 4, outputPerMTokUsd: 16, notes: 'TEXT tokens; the realtime ledger rows (7.23) price audio tokens via the -audio row' },
    { modelId: 'gpt-realtime-audio', provider: 'openai', inputPerMTokUsd: 32, outputPerMTokUsd: 64, notes: 'AUDIO-token rate for gpt-realtime (7.23 voice metering); VERIFY at deploy (D38)' },
    { modelId: 'gemini-2.5-flash-native-audio-latest', provider: 'google', inputPerMTokUsd: 3, outputPerMTokUsd: 12, notes: 'Gemini Live native audio — APPROXIMATE blended rate, owner verifies in the pricing admin (D38)' },
    { modelId: 'gemini-3.1-flash-live-preview', provider: 'google', inputPerMTokUsd: 3, outputPerMTokUsd: 12, notes: 'Gemini Live 3.1 — APPROXIMATE blended rate, owner verifies in the pricing admin (D38)' },
