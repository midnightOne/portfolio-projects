...
4. **Git state:** development head = `claude/semantic-content-management-review` (== `feature/semantic-content-management-2`). `main` is a stale Sept 2025 snapshot until Phase 0 merges. Don't base work on `main`.
